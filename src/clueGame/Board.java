...
public class Board {
	...
	public void initialize() {
		...
		Scanner fileScanner = new Scanner(layoutFile);
		Scanner fileScanner2 = new Scanner(legendFile);
...
//		String[][] gameBoard = new String[MAX_BOARD_SIZE][MAX_BOARD_SIZE];
//		
//		for (int i = 0; i < 22; i++) {
//			for (int j = 0; j < 23; j++) {
//				gameBoard[i][j] = fileScanner.nextLine();
