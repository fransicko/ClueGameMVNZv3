...
public class Tests {
	...
	public void FourDoorDirections() {
		...
		room = board.getCellAt(8, 24);
		assertTrue(room.isDoorway());
		assertEquals(DoorDirection.LEFT, room.getDoorDirection());
		room = board.getCellAt(16, 23);
		assertTrue(room.isDoorway());
	...
	public void testRoomInitials() {
		...
		assertEquals('O', board.getCellAt(11, 0).getInitial());
		// Test last cell in room
		assertEquals('U', board.getCellAt(19, 19).getInitial());
		assertEquals('B', board.getCellAt(21, 2).getInitial());
		// Test a walkway
		assertEquals('X', board.getCellAt(20, 12).getInitial());
		// Test the closet
		assertEquals('L', board.getCellAt(8,16).getInitial());
	}
